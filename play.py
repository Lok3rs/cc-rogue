...
def play_game():
    ...
    orcs_map_b = {
        Monster(randint(11, 20), randint(31, 39), ORC["icon"], ORC["name"], ORC["max_hp"], ORC["loot"], ORC["color"]),
        Monster(randint(4, 12), randint(4, 12), ORC["icon"], ORC["name"], ORC["max_hp"], ORC["loot"], ORC["color"]),
        Monster(randint(57, 63), randint(27, 35), ORC["icon"], ORC["name"], ORC["max_hp"], ORC["loot"], ORC["color"])
    }
    trolls_map_b = {
        Monster(randint(66, 74), randint(7, 18), TROLL["icon"], TROLL["name"], TROLL["max_hp"], TROLL["loot"], TROLL["color"]),
        Monster(randint(31, 36), randint(18, 22), TROLL["icon"], TROLL["name"], TROLL["max_hp"], TROLL["loot"], TROLL["color"])
        
    }
    dragon_map_b = Monster(69, 39, DRAGON["icon"], DRAGON["name"], DRAGON["max_hp"], DRAGON["loot"],DRAGON["color"])
