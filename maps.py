...
MAP_A_ENTITIES = {
    ...
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["dungeon_2"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_3"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_4"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_5"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_5"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_6"]),
    Monster("troll", item=Item("food", "apple", bonus=5), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_6"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_7"]),
    ...
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_8"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_9"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_9"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_10"]),
    Monster("troll", item=Item("food", "apple", bonus=5), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_10"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_11"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_11"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_A_CHAMBERS["room_12"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_A_CHAMBERS["room_12"]),
...
MAP_B_ENTITIES = {
    ...
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_B_CHAMBERS["room_4"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_B_CHAMBERS["dungeon_10"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_10"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_8"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_B_CHAMBERS["room_8"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_11"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_7"]),
    Monster("troll", item=Item("food", "apple", bonus=5), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_3"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_B_CHAMBERS["room_3"]),
    Monster("troll", item=Item("food", "apple", bonus=5), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_5"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_B_CHAMBERS["room_5"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_B_CHAMBERS["room_2"]),
    Monster("troll", item=Item("food", "apple", bonus=5), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_B_CHAMBERS["room_12"]),
...
MAP_C_ENTITIES = {
    ...
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_C_CHAMBERS["room_2"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_C_CHAMBERS["room_3"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_C_CHAMBERS["room_3"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_C_CHAMBERS["room_4"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_C_CHAMBERS["room_4"]),
    Monster("orc", item=Item("food", "meet", bonus=30), talk_to_player=choice(TALK['orc'])).put_on_map(MAP_C_CHAMBERS["room_5"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_C_CHAMBERS["room_5"]),
    Monster("troll", item=Item("food", "apple", bonus=10), talk_to_player=choice(TALK['troll'])).put_on_map(MAP_C_CHAMBERS["room_6"]),
